...
// Auto-create conversation_history table on startup
async function ensureConversationHistory(pool) {
  await pool.query(`
...
module.exports.ensureConversationHistory = ensureConversationHistory;
